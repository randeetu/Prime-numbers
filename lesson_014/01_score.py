...
# Код оставляю для быстрой проверки работоспособности результатов игр.
# results = ['42151724724215172472', 'XXXXXXXXXX', '--------------------', 'X4/34-4-8X4/34-4-8', '3--42/6/5/3--42/6/5/',
#            '1/3/4/5/6/1/3/4/5/6/', '1235-9-8-51235-9-8-5', 'STRIKE-1/spare-3', 'РУССКАЯ-Х/РУССКАЯ-Х/',
#            '3--42/6/5/3--42/6/\/', '/2/2/2/2/2/2/2/2/2/2', '222222////222222////', '/111111114/111111114',
#            '98769748689876974868', '12357948751235794875', '99999999999999999999', '111111111111111111111',
#            'X4/34-4X4/34-4-8-9-', '1111111111111111111', 'XXXXXXXXXXX', '']
#
...
bowling = Bowling(result.result)
bowling.get_score()

# Для проверки
# python 01_score.py --result X4/34-4-8X4/34-4-8
