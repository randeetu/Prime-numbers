...
if (envelop_x >= paper_x) and (envelop_y >= paper_y):
    print("Первое задание ДА!")
elif (envelop_x >= paper_y) and (envelop_y >= paper_x):
    print("первое задание ДА, если перевернуть лист!")
else:
    print("Первое задание НЕТ!")
...
if (hole_x >= brick_x) and (hole_y >= brick_y):
    print("Второе задание ДА, сторонами x и y!")
elif (hole_x >= brick_y) and (hole_y >= brick_x):
    print("Второе задание ДА, сторонами y и x!")
elif (hole_x >= brick_x) and (hole_y >= brick_z):
    print('Второе задание ДА, сторонами x и z!')
elif (hole_x >= brick_z) and (hole_y >= brick_x):
    print("Второе задание ДА, сторонами z и x!")
elif (hole_x >= brick_y) and (hole_y >= brick_z):
    print('Второе задание ДА, сторонами y и z!')
elif (hole_x >= brick_z) and (hole_y >= brick_y):
    print("Второе задание ДА, сторонами z и y!")
else:
    print("НЕ, ни одной стороной!")
